...
const Seo = ({
  ...
  >
    <div className={`seo-inner`}>
      ...
      <div className={`seo-inner-col col-left`}>
      ...
      <div className={`seo-inner-col col-middle`}>
        {
          middle_positive != null && middle_negative != null ?
            ...
            />
          :
            <h1 className="seo-title" dangerouslySetInnerHTML={{ __html: title }} />
      }
      </div>

      <div className={`seo-inner-col col-right`}>
        {children}
      </div>
