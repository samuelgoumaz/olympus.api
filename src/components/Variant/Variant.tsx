...
const Variant = ({
  ...
  >
    <div className={`variant-inner`}>
      ...
      <div className={`variant-inner-col col-left`}>
      ...
      <div className={`variant-inner-col col-middle`}>
        {
          middle_positive != null && middle_negative != null ?
            ...
            />
          :
            <h1 className="variant-title" dangerouslySetInnerHTML={{ __html: title }} />
      }
      </div>

      <div className={`variant-inner-col col-right`}>
        {children}
      </div>
