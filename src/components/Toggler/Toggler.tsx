...
const Toggler = ({
  ...
  >
    <div className={`toggler-inner`}>
      ...
      <div className={`toggler-inner-col col-left`}>
      ...
      <div className={`toggler-inner-col col-middle`}>
        {
          middle_positive != null && middle_negative != null ?
            ...
            />
          :
            <h1 className="toggler-title" dangerouslySetInnerHTML={{ __html: title }} />
      }
      </div>

      <div className={`toggler-inner-col col-right`}>
        {children}
      </div>
