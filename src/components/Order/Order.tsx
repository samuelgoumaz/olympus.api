...
const Order = ({
  ...
  >
    <div className={`order-inner`}>
      ...
      <div className={`order-inner-col col-left`}>
      ...
      <div className={`order-inner-col col-middle`}>
        {
          middle_positive != null && middle_negative != null ?
            ...
            />
          :
            <h1 className="order-title" dangerouslySetInnerHTML={{ __html: title }} />
      }
      </div>

      <div className={`order-inner-col col-right`}>
        {children}
      </div>
