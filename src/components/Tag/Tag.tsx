...
const Tag = ({
  ...
  >
    <div className={`tag-inner`}>
      ...
      <div className={`tag-inner-col col-left`}>
      ...
      <div className={`tag-inner-col col-middle`}>
        {
          middle_positive != null && middle_negative != null ?
            ...
            />
          :
            <h1 className="tag-title" dangerouslySetInnerHTML={{ __html: title }} />
      }
      </div>

      <div className={`tag-inner-col col-right`}>
        {children}
      </div>
