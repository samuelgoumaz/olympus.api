...
const Fx = ({
  ...
  >
    <div className={`fx-inner`}>
      ...
      <div className={`fx-inner-col col-left`}>
      ...
      <div className={`fx-inner-col col-middle`}>
        {
          middle_positive != null && middle_negative != null ?
            ...
            />
          :
            <h1 className="fx-title" dangerouslySetInnerHTML={{ __html: title }} />
      }
      </div>

      <div className={`fx-inner-col col-right`}>
        {children}
      </div>
