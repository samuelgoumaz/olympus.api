...
const Introduction = ({
  ...
  >
    <div className={`introduction-inner`}>
      ...
      <div className={`introduction-inner-col col-left`}>
      ...
      <div className={`introduction-inner-col col-middle`}>
        {
          middle_positive != null && middle_negative != null ?
            ...
            />
          :
            <h1 className="introduction-title" dangerouslySetInnerHTML={{ __html: title }} />
      }
      </div>

      <div className={`introduction-inner-col col-right`}>
        {children}
      </div>
